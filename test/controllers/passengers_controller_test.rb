...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { first_name: @passenger.first_name, flight_id: @passenger.flight_id, last_name: @passenger.last_name }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { first_name: @passenger.first_name, flight_id: @passenger.flight_id, last_name: @passenger.last_name }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
